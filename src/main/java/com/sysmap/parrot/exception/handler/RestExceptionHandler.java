package com.sysmap.parrot.exception.handler;

import com.sysmap.parrot.exception.*;
import com.sysmap.parrot.exception.badRequestException.BadRequestException;
import com.sysmap.parrot.exception.badRequestException.BadRequestExceptionDetails;
import com.sysmap.parrot.exception.forbiddenException.ForbiddenException;
import com.sysmap.parrot.exception.forbiddenException.ForbiddenExceptionDetails;
import com.sysmap.parrot.exception.notFoundException.NotFoundException;
import com.sysmap.parrot.exception.notFoundException.NotFoundExceptionDetails;
import com.sysmap.parrot.exception.validationException.ValidationExceptionDetails;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ForbiddenExceptionDetails> handleForbiddenException(ForbiddenException exception) {
        return new ResponseEntity<>(
